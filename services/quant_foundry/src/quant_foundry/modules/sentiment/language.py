...
def detect_language(text: str) -> str:
    ...
    french_markers = {
        ...
        "qui", "dans", "pour", "avec", "sur", "pas", "ne", "ce", "cette",
        "est", "sont", "a", "au", "aux", "by",  # "by" appears in fr headlines
    }
    # German markers.
    german_markers = {
        "der", "die", "das", "und", "den", "dem", "des", "ein", "eine",
        "einer", "eines", "mit", "von", "zu", "ist", "sind", "auf", "für",
        "nicht", "auch", "noch", "aber", "als", "bei", "durch",
    }
    # Spanish markers.
    spanish_markers = {
        "el", "la", "los", "las", "un", "una", "unos", "unas", "y", "de",
        "del", "que", "en", "es", "son", "por", "con", "para", "se", "su",
        "al", "lo", "más", "pero", "como", "sin", "sobre", "entre",
    }
...
_ES_POSITIVE = [
    "ganancia", "ganancias", "sube", "suben", "crece", "crecen", "aumenta",
    "aumentan", "beneficio", "beneficios", "récord", "alza", "repunte",
    "fuerte", "sólido", "crecimiento", "victoria", "gana", "ganan",
    "aprobado", "lanza", "alianza", "sociedad", "impulso", "impulsan",
    "positivo", "optimista", "éxito", "superar", "supera", "recuperación",
]
_ES_NEGATIVE = [
    "pérdida", "pérdidas", "cae", "caen", "baja", "bajan", "recorta",
    "recortan", "débil", "declive", "decliva", "demanda", "querella",
    "acuerdo", "investigación", "fraude", "quiebra", "suspenso",
    "sanción", "sancionado", "prohibición", "retraso", "alerta", "riesgo",
    "negativo", "pesimista", "fracaso", "incumple", "incumplimiento",
    "despido", "despidos", "crisis", "retiro",
]

#: French positive/negative financial sentiment words.
_FR_POSITIVE = [
    "bénéfice", "bénéfices", "hausse", "monte", "montent", "grimpe",
    "grimpe", "croissance", "croît", "progression", "record", "rebond",
    "fort", "solide", "gagne", "victoire", "approuvé", "lance", "partenariat",
    "impulsion", "positif", "optimiste", "succès", "dépasse", "dépassement",
    "ralliement", "envol", "perce", "prometteur", "favorable", "excellent",
]
_FR_NEGATIVE = [
    "perte", "pertes", "baisse", "tombe", "tombent", "chute", "chutes",
    "faible", "déclin", "décline", "procès", "poursuite", "poursuites",
    "enquête", "fraude", "faillite", "défaut", "sanction", "sanctionné",
    "interdiction", "retard", "alerte", "risque", "négatif", "pessimiste",
    "échec", "crise", "licenciement", "licenciements", "récession",
    "dégradation", "dégrade", "recule", "reculent",
]

#: German positive/negative financial sentiment words.
_DE_POSITIVE = [
    "gewinn", "gewinne", "steigt", "steigen", "wächst", "wachsen", "anstieg",
    "anstiege", "rekord", "erholung", "rallye", "stark", "solide", "wachstum",
    "sieg", "gewinnt", "genehmigt", "startet", "partnerschaft", "schub",
    "positiv", "optimistisch", "erfolg", "übertrifft", "durchbruch",
    "aufschwung", "hoch", "hochpunkt", "verbesserung", "gut", "aussichtsreich",
]
_DE_NEGATIVE = [
    "verlust", "verluste", "fällt", "fallen", "rückgang", "rückgänge",
    "schwach", "rückläufig", "klage", "klagen", "untersuchung", "betrug",
    "pleite", "insolvenz", "ausfall", "sanktion", "sanktioniert", "verbot",
    "verzögerung", "warnung", "risiko", "negativ", "pessimistisch", "misserfolg",
    "krise", "entlassung", "entlassungen", "rezession", "verschlechterung",
    "einbruch", "bricht", "abbau",
]

#: Chinese positive/negative financial sentiment words.
_ZH_POSITIVE = [
    "上涨", "上涨", "大涨", "飙升", "猛涨", "创新高", "高企", "利好",
    "盈利", "增长", "增长", "强劲", "突破", "反弹", "回升", "上涨",
    "利好", "大涨", "走强", "走高", "攀升", "上扬", "丰收", "成功",
    "批准", "合作", "伙伴", "推出", "发布", "超越", "优异", "表现强劲",
]
_ZH_NEGATIVE = [
    "下跌", "大跌", "暴跌", "重挫", "下挫", "下滑", "走低", "利空",
    "亏损", "损失", "疲软", "下滑", "调查", "诉讼", "欺诈", "破产",
    "违约", "制裁", "禁止", "召回", "停牌", "延迟", "警告", "风险",
    "负面", "悲观", "失败", "危机", "裁员", "衰退", "恶化", "暴跌",
]

#: Japanese positive/negative financial sentiment words.
_JA_POSITIVE = [
    "上昇", "急騰", "高騰", "最高値", "好調", "強気", "利益", "増益",
    "成長", "伸び", "上振れ", "好況", "反発", "回復", "急伸", "高値",
    "ブレイク", "成功", "承認", "提携", "パートナーシップ", "発表",
    "強い", "堅調", "買い", "プラス", "期待", "躍進", "躍進", "好転",
    "改善", "上方修正",
]
_JA_NEGATIVE = [
    "下落", "急落", "暴落", "安値", "不調", "弱気", "損失", "減益",
    "減少", "下振れ", "不況", "下落", "急落", "安値", "調査", "訴訟",
    "不正", "破綻", "違約", "制裁", "禁止", "リコール", "停止", "遅延",
    "警告", "リスク", "マイナス", "悲観", "失敗", "危機", "リストラ",
    "悪化", "下方修正",
]
