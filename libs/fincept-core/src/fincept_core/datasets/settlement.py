...
# ``fincept_core.prediction_log._validate_agent_id`` (lines 69-78):
# a future audit grep must find the identical forbidden-character set
# in both modules so the two stores stay symmetric.
