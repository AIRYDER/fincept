...
Importing this package exposes the protocol and registry only.
Tool families register when their modules are imported explicitly.
...
Public surface:
  ...
  - fincept_tools.research   — research.exa_market
