...
1. Adds ``retired`` to the status domain CHECK constraints on
   ...
   ``retired`` is a terminal status â€” no promotion path out of it.
...
No new tables or columns are added â€” only CHECK constraint updates.
"""
...
# Updated metric_type domain â€” adds C7 evidence metric types.
_METRIC_TYPE_DOMAIN = (
